    ...
    <AppShell>
      <div className="dashboard-page">
        <header className="page-header">
          <div>
            <p className="eyebrow">
              OVERVIEW <span className="eyebrow-slash">/</span> MERCHANT
            </p>
            <h1>Dashboard</h1>
            <p className="header-subtitle">
              Monitor revenue opportunities and AI-powered commerce activity.
            </p>
          </div>
          <div className="header-meta">
            ...
            <div className="sync-state">
              ...
              <span className="sync-separator">·</span> Live
            </div>
          </div>
        </header>
